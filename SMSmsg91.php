...
class SMSNotifier_SMSmsg91_Provider implements SMSNotifier_ISMSProvider_Model {

	private $userName;
	private $password;
	private $parameters = array();

	const SERVICE_URI = 'http://api.msg91.com/sendhttp.php?authkey=91105AM7OC5uwmTp55d707dc';
	private static $REQUIRED_PARAMETERS = array('sender', 'route');
	...
	public function send($message, $toNumbers) {
		...
		$params['mobiles'] = implode(',', $toNumbers);
